...
import asu.ser.capstone.pivi.diagram.edit.policies.PiviTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ResultNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ResultNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new PiviTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return PiviElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PiviParserProvider.getParser(PiviElementTypes.Result_2006, getParserElement(), PiviVisualIDRegistry
					.getType(asu.ser.capstone.pivi.diagram.edit.parts.ResultNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, PiviEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
