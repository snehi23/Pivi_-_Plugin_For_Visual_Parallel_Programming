...
import asu.ser.capstone.pivi.diagram.edit.policies.IfStartStatementIfStartFigureCompartmentCanonicalEditPolicy;
import asu.ser.capstone.pivi.diagram.edit.policies.IfStartStatementIfStartFigureCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfStartStatementIfStartFigureCompartmentEditPart extends ListCompartmentEditPart {
	 ...
	 * @generated
	 */
	public IfStartStatementIfStartFigureCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.IfStartStatementIfStartFigureCompartmentEditPart_title;
	}
...
//		result.addFigureListener(new IfStartCompartmentFigureListener(this, roundedRectangle));
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IfStartStatementIfStartFigureCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(PiviVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new IfStartStatementIfStartFigureCompartmentCanonicalEditPolicy());
	}
