...
import asu.ser.capstone.pivi.diagram.edit.policies.IfEndStatementIfEndFigureCompartmentCanonicalEditPolicy;
import asu.ser.capstone.pivi.diagram.edit.policies.IfEndStatementIfEndFigureCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfEndStatementIfEndFigureCompartmentEditPart extends ListCompartmentEditPart {
	 ...
	 * @generated
	 */
	public IfEndStatementIfEndFigureCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.IfEndStatementIfEndFigureCompartmentEditPart_title;
	}
...
//		result.addFigureListener(new IfEndCompartmentFigureListener(this, roundedRectangle));
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IfEndStatementIfEndFigureCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(PiviVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new IfEndStatementIfEndFigureCompartmentCanonicalEditPolicy());
	}
