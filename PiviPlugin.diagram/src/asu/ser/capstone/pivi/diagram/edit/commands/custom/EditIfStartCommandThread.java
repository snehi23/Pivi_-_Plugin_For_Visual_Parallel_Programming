...
public class EditIfStartCommandThread implements Runnable{
	...
	public EditIfStartCommandThread(TransactionalEditingDomain domain, EStructuralFeature feature, EObject modelElement, IWizard wizard) {
		this.domain = domain;
	...
	public void run() {
		...
		org.eclipse.emf.common.command.Command command = SetCommand.create(domain, modelElement,
				feature, ((IfStatementWizard) wizard).getNewCondition());
