 ...
 * @generated
 */
public class IfStartStatementNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IfStartStatementNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = PiviParserProvider.getParser(PiviElementTypes.IfStartStatement_2001, getParserElement(),
					PiviVisualIDRegistry
							.getType(asu.ser.capstone.pivi.diagram.edit.parts.IfStartStatementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
