 ...
 * @generated
 */
public class TerminalInputPortsCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TerminalInputPortsCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Terminal) {
			return false;
		}
		...
		return PiviBaseItemSemanticEditPolicy.getLinkConstraints().canCreateTerminalInputPorts_4001(getSource(),
				getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getInputPorts().add(getTarget());
		}
