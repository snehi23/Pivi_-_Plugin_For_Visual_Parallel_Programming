	...
	*/
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case IfStartStatementEditPart.VISUAL_ID:
			...
			if (IfStartStatementIfStartFigureCompartmentEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case WhileStatementEditPart.VISUAL_ID:
			...
			if (WhileStatementWhileFigureCompartmentEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case IfEndStatementEditPart.VISUAL_ID:
			...
			if (IfEndStatementIfEndFigureCompartmentEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
