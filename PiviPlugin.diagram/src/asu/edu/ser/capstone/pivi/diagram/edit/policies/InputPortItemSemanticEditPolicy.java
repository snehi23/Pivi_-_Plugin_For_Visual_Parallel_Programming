...
import asu.edu.ser.capstone.pivi.diagram.edit.commands.EdgeCreateCommand;
import asu.edu.ser.capstone.pivi.diagram.edit.commands.EdgeReorientCommand;
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PiviVisualIDRegistry.getVisualID(incomingLink) == EdgeEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (PiviElementTypes.Edge_4001 == req.getElementType()) {
			return null;
		}
		return null;
	}
