...
import asu.edu.ser.capstone.pivi.diagram.part.PiviDiagramUpdater;
import asu.edu.ser.capstone.pivi.diagram.part.PiviLinkDescriptor;
import asu.edu.ser.capstone.pivi.diagram.part.PiviNodeDescriptor;
...
public class DiagramCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PiviPackage.eINSTANCE.getDiagram_Statements();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PiviNodeDescriptor> childDescriptors = PiviDiagramUpdater.getDiagram_1000SemanticChildren(viewObject);
	...
	*/
	private Collection<PiviLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
		if (!DiagramEditPart.MODEL_ID.equals(PiviVisualIDRegistry.getModelID(view))) {
		...
		case DiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getDiagram_1000ContainedLinks(view));
			}
		...
		case WhileStartEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getWhileStart_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EndNodeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getEndNode_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case IfStartEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getIfStart_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case IfEndEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getIfEnd_2005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case StartNodeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getStartNode_2006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case EdgeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getEdge_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
