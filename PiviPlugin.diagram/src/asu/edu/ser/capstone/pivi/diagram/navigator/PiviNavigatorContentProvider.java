	...
	*/
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case DiagramEditPart.VISUAL_ID: {
			...
			PiviNavigatorGroup links = new PiviNavigatorGroup(Messages.NavigatorGroupName_Diagram_1000_links,
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					PiviVisualIDRegistry.getType(EndNodeEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					PiviVisualIDRegistry.getType(StartNodeEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					PiviVisualIDRegistry.getType(EdgeEditPart.VISUAL_ID));
		...
		case EdgeEditPart.VISUAL_ID: {
			LinkedList<PiviAbstractNavigatorItem> result = new LinkedList<PiviAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			PiviNavigatorGroup target = new PiviNavigatorGroup(Messages.NavigatorGroupName_Edge_4001_target,
