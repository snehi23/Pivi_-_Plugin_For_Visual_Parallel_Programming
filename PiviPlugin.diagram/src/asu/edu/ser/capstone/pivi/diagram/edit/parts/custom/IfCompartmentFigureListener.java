...
public class IfCompartmentFigureListener implements FigureListener {
	...
	public IfCompartmentFigureListener(ListCompartmentEditPart compartmentEditPart, RoundedRectangle roundedRectangle) {
