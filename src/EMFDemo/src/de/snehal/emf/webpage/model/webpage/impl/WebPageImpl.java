/**
 */
package de.snehal.emf.webpage.model.webpage.impl;

import de.snehal.emf.webpage.model.webpage.Category;
import de.snehal.emf.webpage.model.webpage.WebPage;
import de.snehal.emf.webpage.model.webpage.WebpagePackage;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.snehal.emf.webpage.model.webpage.impl.WebPageImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.snehal.emf.webpage.model.webpage.impl.WebPageImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link de.snehal.emf.webpage.model.webpage.impl.WebPageImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.snehal.emf.webpage.model.webpage.impl.WebPageImpl#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link de.snehal.emf.webpage.model.webpage.impl.WebPageImpl#getCategories <em>Categories</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WebPageImpl extends MinimalEObjectImpl.Container implements WebPage {
	...
	public EList<Category> getCategories() {
		if (categories == null) {
			categories = new EObjectContainmentEList<Category>(Category.class, this, WebpagePackage.WEB_PAGE__CATEGORIES);
		}
		return categories;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebpagePackage.WEB_PAGE__CATEGORIES:
