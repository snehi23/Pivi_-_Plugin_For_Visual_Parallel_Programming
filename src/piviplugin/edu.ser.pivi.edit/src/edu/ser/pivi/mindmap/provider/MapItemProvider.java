/**
 */
package edu.ser.pivi.mindmap.provider;
...
/**
 * This is the item provider adapter for a {@link edu.ser.pivi.mindmap.Map} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MindmapPackage.Literals.MAP__START);
			childrenFeatures.add(MindmapPackage.Literals.MAP__END);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MindmapPackage.Literals.MAP__START,
				 MindmapFactory.eINSTANCE.createStart()));

		newChildDescriptors.add
			(createChildParameter
				(MindmapPackage.Literals.MAP__END,
				 MindmapFactory.eINSTANCE.createEnd()));
	}
