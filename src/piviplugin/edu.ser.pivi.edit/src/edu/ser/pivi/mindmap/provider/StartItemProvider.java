...
/**
 * This is the item provider adapter for a {@link edu.ser.pivi.mindmap.Start} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MindmapPackage.Literals.START__NAME,
				 true,
				 false,
				 false,
	...
	protected void addConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Start_connector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Start_connector_feature", "_UI_Start_type"),
				 MindmapPackage.Literals.START__CONNECTOR,
				 true,
				 false,
				 true,
				 null,
