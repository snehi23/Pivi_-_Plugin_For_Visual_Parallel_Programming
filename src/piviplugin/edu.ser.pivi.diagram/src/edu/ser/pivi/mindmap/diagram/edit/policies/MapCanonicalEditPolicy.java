...
import edu.ser.pivi.mindmap.diagram.part.PiviDiagramUpdater;
import edu.ser.pivi.mindmap.diagram.part.PiviLinkDescriptor;
import edu.ser.pivi.mindmap.diagram.part.PiviNodeDescriptor;
import edu.ser.pivi.mindmap.diagram.part.PiviVisualIDRegistry;

/**
 * @generated
 */
public class MapCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(MindmapPackage.eINSTANCE.getMap_End());
			myFeaturesToSynchronize.add(MindmapPackage.eINSTANCE.getMap_Start());
		}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PiviNodeDescriptor> childDescriptors = PiviDiagramUpdater.getMap_1000SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == EndEditPart.VISUAL_ID || visualID == StartEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PiviNodeDescriptor> childDescriptors = PiviDiagramUpdater
				.getMap_1000SemanticChildren((View) getHost().getModel());
	...
	*/
	private Collection<PiviLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
		if (!MapEditPart.MODEL_ID.equals(PiviVisualIDRegistry.getModelID(view))) {
		...
		case MapEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getMap_1000ContainedLinks(view));
			}
		...
		case EndEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getEnd_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
