...
import edu.ser.pivi.mindmap.diagram.edit.policies.PiviTextSelectionEditPolicy;
...
public class EndNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PiviParserProvider.getParser(PiviElementTypes.End_2001, getParserElement(),
					PiviVisualIDRegistry.getType(edu.ser.pivi.mindmap.diagram.edit.parts.EndNameEditPart.VISUAL_ID));
		}
		return parser;
	}
