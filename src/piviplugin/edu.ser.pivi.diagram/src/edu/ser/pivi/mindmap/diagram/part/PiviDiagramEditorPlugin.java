...
import edu.ser.pivi.mindmap.diagram.providers.ElementInitializers;
import edu.ser.pivi.mindmap.provider.MindmapItemProviderAdapterFactory;
...
public class PiviDiagramEditorPlugin extends AbstractUIPlugin {
	...
	* @generated
	*/
	public static final String ID = "edu.ser.pivi.diagram"; //$NON-NLS-1$
	...
	* @generated
	*/
	public void setLinkConstraints(PiviBaseItemSemanticEditPolicy.LinkConstraints lc) {
