...
import edu.ser.pivi.mindmap.diagram.part.Messages;
	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(topViews, MapEditPart.MODEL_ID), file, false));
	...
	*/
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MapEditPart.VISUAL_ID: {
			...
			PiviNavigatorGroup links = new PiviNavigatorGroup(Messages.NavigatorGroupName_Map_1000_links,
			...
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					PiviVisualIDRegistry.getType(StartConnectorEditPart.VISUAL_ID));
		...
		case EndEditPart.VISUAL_ID: {
			...
			PiviNavigatorGroup incominglinks = new PiviNavigatorGroup(
					Messages.NavigatorGroupName_End_2001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case StartConnectorEditPart.VISUAL_ID: {
			LinkedList<PiviAbstractNavigatorItem> result = new LinkedList<PiviAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			PiviNavigatorGroup target = new PiviNavigatorGroup(Messages.NavigatorGroupName_StartConnector_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PiviNavigatorGroup source = new PiviNavigatorGroup(Messages.NavigatorGroupName_StartConnector_4001_source,
