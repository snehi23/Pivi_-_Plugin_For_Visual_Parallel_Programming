 ...
 * </p>
 * <ul>
 *   <li>{@link edu.ser.pivi.mindmap.impl.EndImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndImpl extends MinimalEObjectImpl.Container implements End {
	...
	protected EClass eStaticClass() {
		return MindmapPackage.Literals.END;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindmapPackage.END__NAME, oldName, name));
	}
