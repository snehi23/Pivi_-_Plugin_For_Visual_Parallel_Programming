...
public class PiviSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PiviPackage.DIAGRAM: {
				Diagram diagram = (Diagram)theEObject;
				T result = caseDiagram(diagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PiviPackage.EDGE: {
				Edge edge = (Edge)theEObject;
				T result = caseEdge(edge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PiviPackage.END_NODE: {
			...
			case PiviPackage.IF_END: {
				...
				if (result == null) result = caseNode(ifEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PiviPackage.IF_START: {
				...
				if (result == null) result = caseNode(ifStart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PiviPackage.INSTRUCTION: {
				...
				if (result == null) result = caseNode(instruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PiviPackage.NODE: {
			...
			case PiviPackage.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PiviPackage.START_NODE: {
			...
			case PiviPackage.WHILE_START: {
				...
				if (result == null) result = caseNode(whileStart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
