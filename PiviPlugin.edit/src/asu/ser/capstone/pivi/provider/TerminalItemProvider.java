...
/**
 * This is the item provider adapter for a {@link asu.ser.capstone.pivi.Terminal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TerminalItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PiviPackage.Literals.TERMINAL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInputPortsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Terminal_inputPorts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Terminal_inputPorts_feature", "_UI_Terminal_type"),
				 PiviPackage.Literals.TERMINAL__INPUT_PORTS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Terminal.class)) {
			case PiviPackage.TERMINAL__NAME:
